import type { Issue, Project, ProjectWorkspace } from "@paperclipai/shared";
...
export const projectsApi = {
  ...
  listSchedules: (id: string, companyId?: string) =>
    api.get<Issue[]>(projectPath(id, companyId, "/schedules")),
};
