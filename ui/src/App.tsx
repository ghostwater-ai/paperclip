...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="projects/:projectId/schedules" element={<ProjectDetail />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="projects/:projectId/schedules" element={<UnprefixedBoardRedirect />} />
...
const testApi = (import.meta as ImportMeta & { vitest?: unknown }).vitest as
  | {
      describe: (name: string, fn: () => void) => void;
      it: (name: string, fn: () => void) => void;
      expect: (value: unknown) => { toContain: (item: string) => void };
    }
  | undefined;
...
if (testApi) {
  ...
  describe("App routes", () => {
    it("includes project schedules under company-prefixed board routes", () => {
      const paths = collectRoutePaths(boardRoutes());
      expect(paths).toContain("projects/:projectId/schedules");
    });

    it("includes unprefixed redirects for project schedules and budget", () => {
